...
namespace Dispatch.Common
{
    ...
    public sealed class Permissions
    {
            ...
            get
            {
                foreach (var item in items)
                    ...
                    { // finding where they key is the dispatch key
                        ...
                        {
                            IPHostEntry hostEntry = Dns.GetHostEntry(item.Key);
        ...
        // ez contains
        public bool CivContains(string license) => CivilianData.Contains(license);
        public bool LeoContains(string license) => LeoData.Contains(license);
